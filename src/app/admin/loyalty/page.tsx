...
const vipLevels = [
    ...
    { id: "silver", name: "Silver", icon: "🥈", minPoints: 500, color: "#C0C0C0", benefits: ["Cocktail de bienvenue", "Réservation prioritaire"] },
...
const badges = [
    ...
    { id: "cocktail_master", name: "Cocktail Master", description: "10 cocktails commandés", icon: "🍹", earned: true, earnedDate: "10 août 2024" },
...
const pointsHistory = [
    ...
    { id: "3", type: "spend", amount: -200, description: "Cocktail offert", date: "10 août 2024" },
...
// Rewards
const rewards = [
    { id: "1", name: "Cocktail Offert", points: 200, icon: "🍹", available: true },
