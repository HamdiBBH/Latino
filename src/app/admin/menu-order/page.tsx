...
const menuItems = [
    ...
    // Cocktails
    { id: "6", name: "Mojito", description: "Rhum, menthe, citron vert", price: 12, category: "cocktails", image: "🍹", popular: true },
    { id: "7", name: "Piña Colada", description: "Rhum, coco, ananas", price: 14, category: "cocktails", image: "🥥" },
    { id: "8", name: "Spritz", description: "Aperol, prosecco, orange", price: 11, category: "cocktails", image: "🍊", popular: true },
    { id: "9", name: "Margarita", description: "Tequila, citron vert, triple sec", price: 13, category: "cocktails", image: "🍸" },
    { id: "10", name: "Virgin Mojito", description: "Sans alcool", price: 8, category: "cocktails", image: "🌿" },
    // Desserts
