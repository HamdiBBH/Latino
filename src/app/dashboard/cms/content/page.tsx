...
const initialContent: ContentField[] = [
    ...
    { id: "4", sectionName: "hero", fieldName: "tags", fieldType: "text", label: "Tags (séparés par virgule)", content: "Beach Club, Restaurant, Mocktails, DJ Sets, Sunset, Plage Privée", placeholder: "Tag1, Tag2, Tag3" },
    ...
    { id: "8", sectionName: "about", fieldName: "description", fieldType: "richtext", label: "Description", content: "Niché sur les plus belles plages de la Méditerranée, Latino Coucou Beach vous offre une expérience unique alliant gastronomie raffinée, mocktails signature et ambiance festive.", placeholder: "Description complète" },
