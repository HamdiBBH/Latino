...
const initialProducts: Product[] = [
    ...
    { id: "7", name: "Virgin Mojito", description: "Menthe, citron vert, eau gazeuse", price: 14, category: "Boissons", available: true },
    { id: "8", name: "Limonade Pitcher", description: "Citron, menthe, fruits frais", price: 25, category: "Boissons", available: true },
];
